...
To make a BPC variable visible in the class defaults of the actor its attached to, you make a variable in the actor and set the BPC variable to it in the actor's BeginPlay / Construction script.
